...
# NOTE: run 01_canopy_metrics_grid.R first 
# this script will read files from  D:\temp\<site>\outputs\tls\5x5_metrics\canopy_metrics\01_basics\chm\
# script will create a folders in each site subfolder
# D:\temp\<site>\outputs\tls\5x5_metrics\canopy_metrics\03_forest_gaps
#
...
#	chm.dir = paste0(output_folder,"/outputs/tls/5x5_metrics/canopy_metrics/01_basics/chm/") 
#	gap.dir = paste0(output_folder,"/outputs/tls/5x5_metrics/canopy_metrics/03_forest_gaps/")
